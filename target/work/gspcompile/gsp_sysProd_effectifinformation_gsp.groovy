...
class gsp_sysProd_effectifinformation_gsp extends GroovyPage {
...
printHtmlPart(22)
invokeTag('render','g',90,['template':("/menues/mainright")],-1)
printHtmlPart(23)
})
invokeTag('ifLoggedIn','sec',95,[:],1)
printHtmlPart(24)
createTagBody(1, {->
printHtmlPart(25)
createClosureForHtmlPart(26, 2)
invokeTag('link','g',101,['action':("index"),'controller':("login")],2)
printHtmlPart(27)
})
invokeTag('ifNotLoggedIn','sec',102,[:],1)
printHtmlPart(28)
expressionOut.print(request.contextPath)
printHtmlPart(29)
}
...
public static final long LAST_MODIFIED = 1401719936485L
