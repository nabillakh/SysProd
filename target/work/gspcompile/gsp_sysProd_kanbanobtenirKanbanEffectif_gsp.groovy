...
class gsp_sysProd_kanbanobtenirKanbanEffectif_gsp extends GroovyPage {
...
invokeTag('link','g',108,['action':("show"),'controller':("Equipe"),'id':(" ${effectifInstance.equipe?.id}")],2)
printHtmlPart(47)
createTagBody(2, {->
printHtmlPart(48)
expressionOut.print(request.contextPath)
...
invokeTag('link','g',117,['controller':("effectif"),'action':("information"),'id':(effectifInstance.id),'title':("Informations")],2)
printHtmlPart(50)
createTagBody(2, {->
printHtmlPart(48)
expressionOut.print(request.contextPath)
...
invokeTag('link','g',123,['controller':("effectif"),'action':("show"),'id':(effectifInstance.id),'title':("Journal")],2)
printHtmlPart(52)
createTagBody(2, {->
printHtmlPart(48)
expressionOut.print(request.contextPath)
...
invokeTag('link','g',131,['controller':("kanban"),'action':("obtenirKanbanEffectif"),'id':(effectifInstance.id),'title':("Projets")],2)
printHtmlPart(54)
createTagBody(2, {->
printHtmlPart(48)
expressionOut.print(request.contextPath)
...
invokeTag('link','g',138,['controller':("effectif"),'action':("indicateurEffectif"),'id':(effectifInstance.id),'title':("Indicateurs")],2)
printHtmlPart(56)
loop:{
int i = 0
...
invokeTag('link','g',198,['action':("show"),'controller':("Kanban"),'id':(kanbanInstance.id)],3)
printHtmlPart(63)
expressionOut.print(fieldValue(bean: kanbanInstance, field: "description"))
printHtmlPart(63)
expressionOut.print(kanbanInstance.phaseActuelle?.nom)
printHtmlPart(63)
invokeTag('formatDate','g',201,['date':(kanbanInstance.dateFinPlanifie)],-1)
printHtmlPart(63)
...
printHtmlPart(65)
invokeTag('remoteFunction','g',230,['controller':("kanban"),'action':("delete"),'params':("\'kanban=\' + monId")],-1)
printHtmlPart(66)
invokeTag('render','g',245,['template':("/menues/mainright")],-1)
printHtmlPart(67)
expressionOut.print(request.contextPath)
printHtmlPart(68)
expressionOut.print(request.contextPath)
...
invokeTag('captureBody','sitemesh',393,[:],1)
printHtmlPart(122)
}
...
public static final long LAST_MODIFIED = 1401719377693L
