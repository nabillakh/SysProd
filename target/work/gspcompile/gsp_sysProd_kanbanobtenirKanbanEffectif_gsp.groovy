...
invokeTag('link','g',114,['action':("show"),'controller':("Equipe"),'id':(" ${effectifInstance.equipe?.id}")],2)
printHtmlPart(47)
createTagBody(2, {->
printHtmlPart(48)
expressionOut.print(request.contextPath)
...
invokeTag('link','g',123,['controller':("effectif"),'action':("information"),'id':(effectifInstance.id),'title':("Informations")],2)
printHtmlPart(50)
createTagBody(2, {->
printHtmlPart(48)
expressionOut.print(request.contextPath)
...
invokeTag('link','g',129,['controller':("effectif"),'action':("show"),'id':(effectifInstance.id),'title':("Journal")],2)
printHtmlPart(52)
createTagBody(2, {->
printHtmlPart(48)
expressionOut.print(request.contextPath)
...
invokeTag('link','g',137,['controller':("kanban"),'action':("obtenirKanbanEffectif"),'id':(effectifInstance.id),'title':("Projets")],2)
printHtmlPart(54)
createTagBody(2, {->
printHtmlPart(48)
expressionOut.print(request.contextPath)
...
invokeTag('link','g',144,['controller':("effectif"),'action':("indicateurEffectif"),'id':(effectifInstance.id),'title':("Indicateurs")],2)
printHtmlPart(56)
loop:{
int i = 0
...
invokeTag('link','g',204,['action':("show"),'controller':("Kanban"),'id':(kanbanInstance.id)],3)
printHtmlPart(63)
expressionOut.print(fieldValue(bean: kanbanInstance, field: "description"))
printHtmlPart(63)
expressionOut.print(kanbanInstance.phaseActuelle?.nom)
printHtmlPart(63)
invokeTag('formatDate','g',207,['date':(kanbanInstance.dateFinPlanifie)],-1)
printHtmlPart(63)
...
printHtmlPart(65)
invokeTag('remoteFunction','g',236,['controller':("kanban"),'action':("delete"),'params':("\'kanban=\' + monId")],-1)
printHtmlPart(66)
...
public static final long LAST_MODIFIED = 1404689232877L
