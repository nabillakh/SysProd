...
invokeTag('link','g',110,['action':("index"),'controller':("kanban")],2)
printHtmlPart(43)
createClosureForHtmlPart(44, 2)
invokeTag('link','g',111,['action':("show"),'controller':("kanban"),'id':(kanbanInstance.id)],2)
printHtmlPart(45)
loop:{
int i = 0
for( mesofInstance in (mesof) ) {
printHtmlPart(46)
invokeTag('set','g',117,['var':("of"),'value':(mesofInstance.id)],-1)
printHtmlPart(47)
loop:{
int j = 0
for( dateLIstInstance in (dateLIst) ) {
printHtmlPart(47)
invokeTag('set','g',119,['var':("laof"),'value':(dateLIstInstance.id)],-1)
printHtmlPart(48)
if(true && (laof == of)) {
printHtmlPart(49)
invokeTag('set','g',121,['var':("deb"),'value':(dateLIstInstance.start)],-1)
printHtmlPart(50)
invokeTag('set','g',122,['var':("fin"),'value':(dateLIstInstance.end)],-1)
printHtmlPart(51)
}
printHtmlPart(52)
j++
...
printHtmlPart(60)
invokeTag('message','g',148,['code':("OF.chargePlanifiee.label"),'default':("Charge Planifiee")],-1)
printHtmlPart(61)
invokeTag('field','g',151,['name':("chargePlanifiee"),'id':("chargeplanifiee${i}"),'value':(fieldValue(bean: mesofInstance, field: 'chargePlanifiee'))],-1)
printHtmlPart(62)
invokeTag('message','g',157,['code':("OF.affectes.label"),'default':("Affectes")],-1)
printHtmlPart(63)
invokeTag('select','g',160,['id':("affectes${i}"),'multiple':("multiple"),'name':("affectes"),'from':(application.RH.Effectif.list()),'optionKey':("id"),'required':(""),'value':(mesofInstance?.affectes*.id),'class':("span12 with-search")],-1)
printHtmlPart(64)
...
invokeTag('form','g',202,['url':([action:'majOF'])],3)
printHtmlPart(71)
i++
}
}
printHtmlPart(72)
invokeTag('remoteFunction','g',224,['controller':("kanban"),'action':("majOF"),'params':("\'monId=\' + id+ '&charge=\' + charge+ '&dateFinPlanifie=\' + dateFinPlanifie+ '&dateDebutPlanifie=\' + dateDebutPlanifie+ '&affectes=\' + affectes")],-1)
printHtmlPart(73)
...
public static final long LAST_MODIFIED = 1404689460063L
