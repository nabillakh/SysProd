...
invokeTag('link','g',156,['action':("index"),'controller':("kanban"),'class':("btn")],3)
printHtmlPart(50)
invokeTag('submitButton','g',157,['class':("btn btn-primary"),'name':("create"),'value':("Mettre à jour")],-1)
printHtmlPart(51)
})
invokeTag('form','g',162,['url':([action:'nouveauKanban'])],2)
printHtmlPart(52)
invokeTag('render','g',193,['template':("/menues/mainright")],-1)
printHtmlPart(53)
expressionOut.print(request.contextPath)
printHtmlPart(54)
expressionOut.print(request.contextPath)
...
invokeTag('captureBody','sitemesh',338,[:],1)
printHtmlPart(108)
}
...
public static final long LAST_MODIFIED = 1404689364049L
