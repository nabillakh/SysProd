...
printHtmlPart(14)
invokeTag('hiddenField','g',93,['name':("kanban"),'id':("monKanban"),'value':("ok")],-1)
printHtmlPart(15)
invokeTag('hiddenField','g',94,['name':("chargePlanifiee"),'id':("chargePlanifiee"),'value':("40")],-1)
printHtmlPart(16)
invokeTag('hiddenField','g',123,['name':("monId"),'id':("monId"),'value':("1")],-1)
printHtmlPart(17)
...
public static final long LAST_MODIFIED = 1401956636635L
