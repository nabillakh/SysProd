...
class gsp_sysProd_administrationressource_gsp extends GroovyPage {
...
invokeTag('link','g',207,['action':("show"),'controller':("Effectif"),'id':(EffectifInstance.id)],3)
printHtmlPart(48)
...
printHtmlPart(48)
expressionOut.print(EffectifInstance.entreprise.nom)
printHtmlPart(49)
i++
}
}
...
invokeTag('link','g',265,['action':("show"),'controller':("Competence"),'id':(competenceInstance.id)],3)
printHtmlPart(53)
...
invokeTag('link','g',297,['action':("show"),'controller':("Droit"),'id':(droitInstance.id)],3)
printHtmlPart(56)
i++
}
}
printHtmlPart(57)
invokeTag('render','g',328,['template':("/menues/mainright")],-1)
printHtmlPart(58)
expressionOut.print(request.contextPath)
printHtmlPart(59)
expressionOut.print(request.contextPath)
...
invokeTag('captureBody','sitemesh',473,[:],1)
printHtmlPart(113)
}
...
public static final long LAST_MODIFIED = 1401788809985L
