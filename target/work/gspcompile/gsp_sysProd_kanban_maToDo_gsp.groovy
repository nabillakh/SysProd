...
class gsp_sysProd_kanban_maToDo_gsp extends GroovyPage {
...
printHtmlPart(7)
expressionOut.print(monOF.getChargeRealisee() / monOF.chargePlanifiee)
printHtmlPart(8)
expressionOut.print(monOF.getChargeRealisee() / monOF.chargePlanifiee)
printHtmlPart(9)
i++
...
public static final long LAST_MODIFIED = 1404951303298L
