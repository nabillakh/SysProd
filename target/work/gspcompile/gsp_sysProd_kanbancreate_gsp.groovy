...
class gsp_sysProd_kanbancreate_gsp extends GroovyPage {
...
createTagBody(2, {->
printHtmlPart(45)
invokeTag('render','g',151,['template':("form")],-1)
printHtmlPart(46)
createClosureForHtmlPart(47, 3)
invokeTag('link','g',157,['action':("index"),'controller':("kanban"),'class':("btn")],3)
printHtmlPart(48)
invokeTag('submitButton','g',158,['class':("btn btn-primary"),'name':("create"),'value':("Créer")],-1)
printHtmlPart(49)
})
invokeTag('form','g',163,['url':([action:'nouveauKanban'])],2)
printHtmlPart(50)
invokeTag('render','g',194,['template':("/menues/mainright")],-1)
printHtmlPart(51)
expressionOut.print(request.contextPath)
printHtmlPart(52)
expressionOut.print(request.contextPath)
...
public static final long LAST_MODIFIED = 1404690088114L
