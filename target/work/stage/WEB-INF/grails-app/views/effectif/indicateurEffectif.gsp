      ...
      <div class="row-fluid">
        ...
        <article>
            <div class="span6">
              ...
              <div id="donutEffectif" style="height:350px; margin:0;"></div>
									        		
            
            </div>
            <div class="span6">
              <center><h5> Développement de compétences </h5></center>
              <div id="donutCompetence" style="height:350px; margin:0;"></div>
        ...
        <article class="span12">
            ...
            <div class="span6"> 
              ...
              <div id="deltaChargeCapaEffectif" class="chart" style="height:350px; margin:0;"></div>
