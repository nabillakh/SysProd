...
<html lang="en">
 ...
 <g:render template="/menues/mainleft" />
     ...
     <!-- main content --><div id="page-content"> <div class="alert adjusted alert-info">
							...
							<strong>Info!</strong> Cette page récapitule l'ensemble des données RH de votre entrperise.
       </div>
					<!-- page header -->
					<!-- page header -->
					<h3 id="page-header">Management des ressources humaines</h3>	
									        ...
									        <!-- content goes here -->
												...
												<table class="table table-striped table-bordered responsive" id="dtable">
													...
													<tbody class="responsive">
                                                                                                                ...
                                                                                                                <g:each in="${effectifList}" status="i" var="effectifInstance">
									        ...
									        <!-- content goes here -->
												...
												<table class="table table-striped table-bordered responsive" id="dtable">
													...
													<tbody class="responsive">
                                                                                                                ...
                                                                                                                <g:each in="${equipeListe}" status="i" var="equipeInstance">
                                                                                                                  <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                                                                                                    <td><center><g:link action="show" controller="equipe" id="${equipeInstance.id}">${fieldValue(bean: equipeInstance, field: "nom")}</g:link></center></td>
                                                                                                                
                                                                                                                <td><center>${equipeInstance.effectifs.size()}</center></td>
                                                                                                                <td><center>${equipeInstance.nom}</center></td>
                                                                                                                <td><center>${equipeInstance.getListeKanban().size()}</center></td>
                                                                                                                </tr>
                                                                                                                </g:each>
													</tbody>
												</table>
