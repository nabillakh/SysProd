...
<html lang="en">
 ...
 <g:render template="/menues/mainleft" />
     ...
     <!-- main content --><div id="page-content"> <div class="alert adjusted alert-info">
							<button class="close" data-dismiss="alert">×</button>
							<i class="cus-exclamation"></i>
							<strong>Info!</strong> Cette page récapitule l'ensemble des famille d'activités de votre entrperise. Vous pouvez à partir de cette page naviguer sur tous vers tous vos processus.
       </div>
					<!-- page header -->
					<!-- page header -->
					<h3 id="page-header">Management des familles d'activités</h3>	
									        ...
									        <!-- content goes here -->
												...
												<table class="table table-striped table-bordered responsive" id="dtable">
													...
													<tbody class="responsive">
                                                                                                                ...
                                                                                                                <g:each in="${familleList}" status="i" var="familleInstance">
                                                                                                                  <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                                                                                                    <td><center><g:link action="show" controller="famille" id="${familleInstance.id}">${fieldValue(bean: familleInstance, field: "nom")}</g:link></center></td>
                                                                                                                
                                                                                                                <td><center>${familleInstance.ordo.size()}</center></td>
                                                                                                                <td><center>${familleInstance.ordo*.nom}</center></td>
                                                                                                                <td><center>${familleInstance.nbProjets}</center></td>
                                                                                                                </tr>
                                                                                                                </g:each>
													</tbody>
												</table>
