...
if ($('#chargeCapaEffectif').length) {
	...
	AmCharts.ready(function() {
       ...
       if ($('#deltaChargeCapaEffectif').length){
	...
	var chartDataDelta =  $.ajax({
                   type:'GET',
                   url: '/SysProd/activite/deltaChargeEffectif',
                   async: false,
                   global: false,
                   data : {
                     monId : monId2, 
               ...
               Morris.Bar({
		  element: 'deltaChargeCapaEffectif',
		  axes: true,
		  grid: true,
		  data: capaCharge,
		  xkey: 'mois',
