...
<section id="widget-grid" class="">
												...
												<table class="table table-striped table-bordered responsive" id="dtable">
													<thead>
														<tr>
                                                                                                                  ...
                                                                                                                  <th>Nom du projet</th>
															<th>Description</th>
															<th>Phase actuelle du projet</th>
															<th>Date de fin planifiée</th>
															<th>Charge facturée</th>
															<th>En cours ?</th>
														</tr>
													</thead>
							...
							<!-- end row-fluid -->
                                                        ...
                                                        <script>
                                                          function voir(monId) {
                                                                    window.location = "/SysProd/kanban/show/"+monId;
                                                          }        
                                                          function editer(monId) {
                                                                    window.location = "/SysProd/kanban/edit/"+monId;
                                                          }       
                                                          function gererOf(monId) {
                                                                    window.location = "/SysProd/kanban/gestionOf/"+monId;
                                                          }       
