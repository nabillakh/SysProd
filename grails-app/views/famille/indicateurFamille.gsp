 ...
 <div id="page-content">
    <div class="fluid-container">
      <div class="alert adjusted alert-info">
							...
							<strong>Info!</strong> Cette page permet d'accéder à l'ensemble des activités liées à cette famille : planifiée, réalisée, lancée...
						</div>
...
<section id="widget-grid" class="">
        ...
        <g:hiddenField name="monId" id="monId" value="${familleInstance.id}"/>
        <g:hiddenField name="projetTotal" id="projetTotal" value="${kanbanList.size()}"/>
        <g:hiddenField name="projetEnCours" id="projetEnCours" value="${kanbansEnCours}"/>
        <g:hiddenField name="projetRealise" id="projetRealise" value="${(kanbansFinis.size())}"/>
        <article>
            <div class="span6">
              <center><h5> Livrables en cours et livrés </h5></center>
              <div id="projetFamille" style="height:350px; margin:0;"></div>
									        		
            
            </div>
            <div class="span6">
              <center><h5> Charges facturée et réalisée moyenne </h5></center>
              <div id="productiviteFamille" style="height:350px; margin:0;"></div>
        <g:hiddenField name="chargeFacturee" id="chargeFacturee" value="${chargeFacturee}"/>
        <g:hiddenField name="chargeRealisee" id="chargeRealisee" value="${chargeRealisee}"/>
									        		
            
            </div>
								</article><article>
            <div class="span6">
              <center><h5> Livrables par client </h5></center>
              <div id="volumeClients" style="height:350px; margin:0;"></div>
									        		
            
            </div>
          
            <div class="span6">
              <center><h5> Productivité par client </h5></center>
              <div id="prodClients" style="height:350px; margin:0;"></div>
...
<g:render template="/menues/mainright" />
    ...
    <script src="${request.contextPath}/js/include/indicateurFamille.js"></script>
