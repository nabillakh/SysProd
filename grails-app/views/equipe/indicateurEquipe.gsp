...
<div id="page-content">
    ...
    <div id="start">
      ...
      <section>
      <div class="row-fluid">
        <g:hiddenField name="monId" id="monId" value="${equipeInstance.id}"/>
        <article>
            <div class="span6">
              <center><h5> Répartition de la charge de travail </h5></center>
              <div id="donutEquipe" style="height:350px; margin:0;"></div>
									        		
            
            </div>
            <div class="span6">
              <center><h5> Développement de compétences </h5></center>
              <div id="donutCompetenceEquipe" style="height:350px; margin:0;"></div>
        ...
        <article class="span12">
            <div class="span6">
              ...
              <div id="chargeCapaEquipe" style="height:350px; margin:0;"></div>
									        		
            
            </div>
            <div class="span6"> 
              <center><h5> Delta charge capacité </h5></center>
              <div id="deltaChargeCapaEquipe" class="chart" style="height:350px; margin:0;"></div>
...
<g:render template="/menues/mainright" />
    ...
    <script src="${request.contextPath}/js/include/indicateurEquipe.js"></script>
