	...
	<body>
		...
		<div id="show-test" class="content scaffold-show" role="main">
			...
			<ol class="property-list test">
				...
				<g:if test="${testInstance?.nom}">
				<li class="fieldcontain">
					<span id="nom-label" class="property-label"><g:message code="test.nom.label" default="Nom" /></span>
					
						<span class="property-value" aria-labelledby="nom-label"><g:fieldValue bean="${testInstance}" field="nom"/></span>
				...
				<li class="fieldcontain">
					<span id="test-label" class="property-label"><g:message code="test.test.label" default="Test" /></span>
						...
						<span class="property-value" aria-labelledby="test-label"><g:formatBoolean boolean="${testInstance?.test}" /></span>
